...
![3. 系统架构](diagrams/SOLUTION-DESIGN-01-3-系统架构.svg)
...
![4. 首个工作流：严格代码变更与独立审核](diagrams/SOLUTION-DESIGN-02-4-首个工作流-严格代码变更与独立审核.svg)
...
![7. 可扩展 Workflow](diagrams/SOLUTION-DESIGN-03-7-可扩展-workflow.svg)
...
![10. 数据模型](diagrams/SOLUTION-DESIGN-04-10-数据模型.svg)
